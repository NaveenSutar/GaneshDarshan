package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Bogarves;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Bogarves.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Bogarves.Details.SwipeActivity;
...
public class BogarvesActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = BogarvesActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/bogarves.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(BogarvesActivity.this, 3));
