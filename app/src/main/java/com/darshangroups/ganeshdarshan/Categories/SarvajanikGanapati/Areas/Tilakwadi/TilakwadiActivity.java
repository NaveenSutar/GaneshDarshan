package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Tilakwadi;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Tilakwadi.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Tilakwadi.Details.SwipeActivity;
...
public class TilakwadiActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = TilakwadiActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/tilakwadi.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(TilakwadiActivity.this, 3));
