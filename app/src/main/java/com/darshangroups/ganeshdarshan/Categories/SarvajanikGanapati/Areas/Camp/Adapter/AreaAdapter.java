package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Camp.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, CampActivity listener) {
