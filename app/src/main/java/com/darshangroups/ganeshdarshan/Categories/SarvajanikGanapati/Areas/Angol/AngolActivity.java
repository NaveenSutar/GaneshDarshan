package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Angol;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Angol.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Angol.Details.SwipeActivity;
...
public class AngolActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = AngolActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/angol.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(AngolActivity.this, 3));
