package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Hindalga;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Hindalga.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Hindalga.Details.SwipeActivity;
...
public class HindalgaActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = HindalgaActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/hindalga.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(HindalgaActivity.this, 3));
