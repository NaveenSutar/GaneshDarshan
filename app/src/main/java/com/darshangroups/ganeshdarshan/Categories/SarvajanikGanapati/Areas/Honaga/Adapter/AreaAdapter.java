package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Honaga.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, HonagaActivity listener) {
