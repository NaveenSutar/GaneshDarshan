package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Vadagaon.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, VadagaonActivity listener) {
