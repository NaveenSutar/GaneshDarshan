package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Honaga;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Honaga.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Honaga.Details.SwipeActivity;
...
public class HonagaActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = HonagaActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/honaga.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(HonagaActivity.this, 3));
