package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Kangrali;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Kangrali.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Kangrali.Details.SwipeActivity;
...
public class KangraliActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = KangraliActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/kangrali.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(KangraliActivity.this, 3));
