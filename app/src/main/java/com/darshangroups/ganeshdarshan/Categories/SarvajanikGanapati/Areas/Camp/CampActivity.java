package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Camp;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Camp.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Camp.Details.SwipeActivity;
...
public class CampActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = CampActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/camp.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(CampActivity.this, 3));
