package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Angol.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, AngolActivity listener) {
