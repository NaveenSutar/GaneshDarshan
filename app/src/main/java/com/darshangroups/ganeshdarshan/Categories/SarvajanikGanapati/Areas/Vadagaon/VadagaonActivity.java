package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Vadagaon;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Vadagaon.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Vadagaon.Details.SwipeActivity;
...
public class VadagaonActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = VadagaonActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/vadagaon.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(VadagaonActivity.this, 3));
