package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Khanapur;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Khanapur.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Khanapur.Details.SwipeActivity;
...
public class KhanapurActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = KhanapurActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/khanapur.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(KhanapurActivity.this, 3));
