package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Chennamma;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Chennamma.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Chennamma.Details.SwipeActivity;
...
public class ChennammaActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = ChennammaActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/chennamma.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(ChennammaActivity.this, 3));
