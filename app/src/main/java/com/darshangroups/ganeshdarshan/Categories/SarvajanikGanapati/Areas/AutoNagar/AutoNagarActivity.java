package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.AutoNagar;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.AutoNagar.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.AutoNagar.Details.SwipeActivity;
...
public class AutoNagarActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = AutoNagarActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/auto_nagar.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(AutoNagarActivity.this, 3));
