package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.FortRoad;
...
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.FortRoad.Adapter.AreaAdapter;
import com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.FortRoad.Details.SwipeActivity;
...
public class FortRoadActivity extends AppCompatActivity implements AreaAdapter.AreaAdapterListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = FortRoadActivity.class.getSimpleName();
    // url to fetch contacts json
    private static final String URL = "http://brainways.in/ganeshdarshan/areas/fort_road.php?key=123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        recyclerView.setAdapter(mAreaAdapter);
        recyclerView.setLayoutManager(new GridLayoutManager(FortRoadActivity.this, 3));
