package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.NehruNagar.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, NehruNagarActivity listener) {
