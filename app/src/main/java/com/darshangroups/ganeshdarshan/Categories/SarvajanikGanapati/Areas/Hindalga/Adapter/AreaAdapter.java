package com.darshangroups.ganeshdarshan.Categories.SarvajanikGanapati.Areas.Hindalga.Adapter;
...
public class AreaAdapter extends RecyclerView.Adapter<AreaAdapter.MyViewHolder> implements Filterable {
    ...
    public AreaAdapter(Context context, List<GaneshaData> contactList, HindalgaActivity listener) {
